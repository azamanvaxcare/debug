...
public class PatientsInsuranceByStateTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/patients/insurance/bystate/FL";
    ...
    [Fact]
    public async Task GetPatientsInsuranceByState_ShouldReturnInsuranceData()
    {
        try
        {
            // Arrange
    ...
    [Fact]
    public void GetPatientsInsuranceByState_ShouldValidateRequiredHeaders()
    {
        // Arrange
