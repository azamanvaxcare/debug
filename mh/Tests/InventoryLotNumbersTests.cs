...
public class InventoryLotNumbersTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/inventory/lotnumbers";
    ...
    [Fact]
    public async Task GetInventoryLotNumbers_ShouldReturnLotNumbersData()
    {
        try
        {
            // Arrange
    ...
    [Fact]
    public void GetInventoryLotNumbers_ShouldValidateRequiredHeaders()
    {
        // Arrange
