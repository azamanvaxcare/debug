...
public class PatientsStafferShotAdministratorsTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/patients/staffer/shotadministrators";
    ...
    [Fact]
    public async Task GetPatientsStafferShotAdministrators_ShouldReturnShotAdministratorsData()
    {
        try
        {
            // Act
    ...
    [Fact]
    public void GetPatientsStafferShotAdministrators_ShouldValidateRequiredHeaders()
    {
        // Arrange
