...
public class SetupCheckDataTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/setup/checkData";

    public SetupCheckDataTests()
    {
        // Setup configuration
    ...
    [Fact]
    public async Task GetSetupCheckData_ShouldReturnCheckData()
    {
        try
        {
            // Arrange
    ...
    public void GetSetupCheckData_ShouldValidateEndpointStructure()
    {
        ...
        var fullUrl = $"{baseUrl}/api/setup/checkData?partnerId=178764&clinicId=89534";
        var expectedEndpoint = "/api/setup/checkData";
        var expectedQuery = "?partnerId=178764&clinicId=89534";
    ...
    [Fact]
    public void GetSetupCheckData_ShouldValidateRequiredHeaders()
    {
        // Arrange
