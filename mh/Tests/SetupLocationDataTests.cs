...
public class SetupLocationDataTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/setup/LocationData";
    ...
    [Fact]
    public async Task GetSetupLocationData_ShouldReturnLocationData()
    {
        try
        {
            // Arrange
    ...
    [Fact]
    public void GetSetupLocationData_ShouldValidateRequiredHeaders()
    {
        // Arrange
