...
public class PatientsClinicTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/patients/clinic";

    public PatientsClinicTests()
    {
        // Setup configuration
    ...
    [Fact]
    public async Task GetPatientsClinic_ShouldReturnClinicData()
    {
        try
        {
            // Act
    ...
    [Fact]
    public void GetPatientsClinic_ShouldValidateEndpointStructure()
    {
        // Arrange
        var baseUrl = _configuration["ApiConfiguration:BaseUrl"];
        var fullUrl = $"{baseUrl}/api/patients/clinic";
        var expectedEndpoint = "/api/patients/clinic";
    ...
    [Fact]
    public void GetPatientsClinic_ShouldValidateRequiredHeaders()
    {
        // Arrange
