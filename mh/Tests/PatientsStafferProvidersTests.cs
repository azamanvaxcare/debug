...
public class PatientsStafferProvidersTests : IDisposable
{
    private readonly HttpClientService _httpClientService;
    private readonly TestUtilities _testUtilities;
    private readonly IConfiguration _configuration;
    private readonly string _endpoint = "/api/patients/staffer/providers";

    public PatientsStafferProvidersTests()
    {
        // Setup configuration
    ...
    [Fact]
    public async Task GetPatientsStafferProviders_ShouldReturnProvidersData()
    {
        try
        {
            // Act
    ...
    [Fact]
    public void GetPatientsStafferProviders_ShouldValidateEndpointStructure()
    {
        // Arrange
        var baseUrl = _configuration["ApiConfiguration:BaseUrl"];
        var fullUrl = $"{baseUrl}/api/patients/staffer/providers";
        var expectedEndpoint = "/api/patients/staffer/providers";
    ...
    [Fact]
    public void GetPatientsStafferProviders_ShouldValidateRequiredHeaders()
    {
        // Arrange
